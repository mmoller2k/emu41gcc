...
/*                                            */
/* ilhdisc2.c   LIF drive emulation module    */
/*                                            */
...
static char did[]="HDRIVE2";  /* Device ID */
...
void init_ilhdisc2(char *fic)
{
  if (fic[0]==0) strcpy(hdiscfile,"hdrive2.dat"); else strcpy(hdiscfile,fic);
  status=0;
  adr=0;
  ptsdi=0;
  fetat=0;
